...
import NayaBazzar.config.JwtProvider;
...
import NayaBazzar.repository.VerificationCodeRepository;
import NayaBazzar.response.ApiResponse;
import NayaBazzar.response.AuthResponse;
import NayaBazzar.service.EmailService;
import NayaBazzar.service.SellerReportService;
import NayaBazzar.service.SellerService;
import NayaBazzar.service.VerificationService;
import NayaBazzar.service.*;
import NayaBazzar.service.impl.CustomeUserServiceImplementation;
import NayaBazzar.utils.OtpUtils;
...
public class SellerController {
    ...
    public ResponseEntity<ApiResponse> sentLoginOtp(@RequestBody VerificationCode req) throws MessagingException, SellerException {
        ...
        String subject = "Naya Bazaar Login Otp";
...
//        Seller savedSeller = sellerService.createSeller(seller);
    ...
    public ResponseEntity<Seller> createSeller(@RequestBody Seller seller) throws SellerException, MessagingException {
        ...
        String subject = "Naya Bazaar Email Verification Code";
        String text = "Welcome to Naya Bazaar, verify your account using this link ";
